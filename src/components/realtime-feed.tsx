        ...
        {updates.length === 0 ? (
          ...
          updates.map((update) => (
            <Card
              ...
              className={
                update.isSOS
                  ? "border-red-500 bg-red-50 dark:bg-red-950 shadow-[0_0_15px_rgba(239,68,68,0.3)] animate-pulse-border relative overflow-hidden"
                  : ""
              }
            >
              {update.isSOS && <div className="absolute top-0 left-0 w-full h-1 bg-red-600"></div>}
              <CardContent className="pt-6">
                <div className="flex gap-4">
                  <Avatar>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-baseline gap-2">
                      ...
                      {update.isSOS && (
                        <span className="text-xs font-bold bg-red-600 text-white px-2 py-0.5 rounded-full ml-2 uppercase animate-pulse">
                          S.O.S
                        </span>
                      )}
                    </div>
                    <p
                      className={`whitespace-pre-wrap ${update.isSOS ? "text-red-900 dark:text-red-100 font-medium" : "text-gray-800"}`}
                    >
                      {update.content}
                    </p>
                  </div>
