...
export function Sidebar({ townSlug, currentPage, pages }: SidebarProps) {
  return (
    <nav className="w-full lg:w-64 shrink-0">
      <div className="sticky top-20 rounded-2xl border border-wiki-border overflow-hidden theme-transition" style={{ background: "var(--color-wiki-card)", backdropFilter: "blur(12px)" }}>
        <div className="px-4 py-3" style={{ background: "linear-gradient(135deg, var(--color-coral-500) 0%, var(--color-coral-700) 100%)" }}>
