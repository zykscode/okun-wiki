    ...
    return (
      <div className="max-w-md mx-auto rounded-2xl bg-neutral-900/50 backdrop-blur-xl border border-green-500/30 p-5 text-left shadow-[0_0_40px_rgba(34,197,94,0.1)]">
        ...
        <p className="text-neutral-300 text-sm">
          There are currently no active emergency or S.O.S reports in Okun land.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4 w-full max-w-md mx-auto">
      {updates.map((update) => (
        <div
          key={update.id}
          className="rounded-2xl bg-neutral-900/80 backdrop-blur-xl border border-red-500/50 p-5 text-left shadow-[0_0_40px_rgba(239,68,68,0.15)] relative overflow-hidden"
        >
          ...
          <Link
            href={`/communities/${update.community.slug}`}
            className="text-neutral-400 text-xs hover:text-white transition-colors flex items-center gap-1"
          >
