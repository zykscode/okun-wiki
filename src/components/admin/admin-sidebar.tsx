...
export function AdminSidebar() {
  ...
  return (
    <aside
      className="w-64 border-r border-wiki-border shrink-0 hidden lg:block theme-transition"
      style={{ background: "var(--color-wiki-card)" }}
    >
      <div className="p-4 border-b border-wiki-border">
        <h2 className="font-display font-medium text-lg text-wiki-text tracking-tight">
          Admin Panel
        </h2>
