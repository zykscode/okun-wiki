                ...
                <div className="flex gap-2 mb-4">
                  {community.whatsappLink && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-xs bg-green-100 text-green-700 dark:bg-green-500/10 dark:text-green-400 px-2 py-1 rounded-md font-medium hover:bg-green-200 transition-colors"
                    >
                      WhatsApp Group
                    </a>
                  )}
                  {community.telegramLink && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-xs bg-blue-100 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400 px-2 py-1 rounded-md font-medium hover:bg-blue-200 transition-colors"
                    >
                      Telegram Group
                    </a>
                  )}
