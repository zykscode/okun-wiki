...
export interface TownPage {
  id: string;
  type: "HISTORY" | "CULTURE" | "GEOGRAPHY" | "ECONOMY" | "CUSTOM";
  title: string;
  slug: string;
  content: string;
  order: number;
...
export interface ProminentPerson {
  id: string;
  name: string;
  title: string | null;
  role: string;
...
export const towns: Town[] = [
  ...
  },
  {
    ...
    people: [
      {
        id: "cmo3msrw5000oath3zko0aosv",
        name: "Rev. S. A. Adebiyi",
        title: "Rev.",
        role: "Religious Leader & Educator",
        biography:
          "One of the pioneering Nigerian clergymen who worked alongside the missionaries in Egbe. His contributions to education and community development laid the foundation for Egbe's reputation as a center of learning.",
        birthYear: 1910,
        deathYear: 1985,
        isAlive: false,
      },
